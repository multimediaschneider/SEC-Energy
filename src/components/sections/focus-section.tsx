    ...
    <>
      <div className="bg-emerald-700 bg-opacity-20 pb-6">
        ...
        <BodyText>
          ...
          idealerweise klimaneutraler Lösungen. Dabei gewährleisten wir durch
          eine vorausschauende wirtschaftliche Analyse die langfristige
          Rentabilität dieser Maßnahmen. Präzise Emissionsberechnungen belegen
          zudem die Relevanz unserer Ansätze und deren positiven Einfluss auf
        ...
        <div className="mb-12">
          ...
          <CollapsibleText
            collapsibleContent={
              <ul className="list-disc list-inside">
                <li>
                  Webgestützte Kartierung von Heizzentralen, Schlüsseltresoren
                  und Medienleitungen zu deren Sicherheit bei Tiefbauarbeiten
                </li>
                <li>
                ...
                <li>
                  Fabrikatsunabhängige Gebäudeleittechnik inkl. historische
                  Trends für Kundenrückfragen
                </li>
                <li>
                ...
                <li>
                  Gegenüberstellung verschiedener technischer Lösungsvarianten
                  und deren wirtschaftliche Auswirkung
                </li>
                <li>
          ...
          <CollapsibleText
            collapsibleContent={
              <ul className="list-disc list-inside">
                <li>
                  Begleitung bei der Entwicklung und Betreuung einer Software
                  zur Energieabrechnung
                </li>
                <li>
                  Ausbau von funkgestützten und internetgestützten
                  Ablesesystemen
                </li>
                <li>
          ...
          <CollapsibleText
            collapsibleContent={
              <ul className="list-disc list-inside">
                ...
                <li>
                  Preisverhandlung und Vertragsgestaltung bei dem Bezug von
                  Erdgas und Fernwärme
                </li>
                <li>
                  Überwachung des Energieeinkaufes und Prüfung der
                  Preisanpassung
                </li>
              </ul>
            }
          ...
          <CollapsibleText
            collapsibleContent={
              <ul className="list-disc list-inside">
                ...
                <li>
                  Mietrecht und WEG-Recht im Kontext mit
          ...
          <CollapsibleText
            collapsibleContent={
              <ul className="list-disc list-inside">
                ...
                <li>
                  Überprüfung der EnEV-Berechnungen bei energetischer Sanierung
                  in Bezug auf Wärmebedarf für Raumheizung und Trinkwarmwasser
                </li>
