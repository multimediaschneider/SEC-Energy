export const ABOUT_SECTION_CONTENT = {
  companyInfo: {
    heading: "Über SEC",
    text: `SEC Energieconsulting ist ein herstellerunabhängiges Unternehmen, das sich auf die Planung, Bauabnahme und den Betrieb von Wärmeversorgungsanlagen spezialisiert hat. Unsere Schwerpunkte liegen im Bereich Wärmecontracting, Erdgas- und Biomethan-Blockheizkraftwerke (BHKW), Holzhackschnitzel- und Holzpelletsheizungen, Solarthermie, Wärmepumpen, Geothermie und Ladeinfrastruktur für E-Mobilität. Wir bieten umfassende Leistungen von Machbarkeitsstudien bis hin zur Anlagenoptimierung und arbeiten in einem Netzwerk von Spezialisten zusammen, um klimaschonende Lösungen zu realisieren.`,
  },
  management: {
